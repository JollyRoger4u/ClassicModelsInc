...
?>
    <tr class="cartitem">
        ...
        <td><button id="subtract" onclick="subtract(<?php echo $cart_item['noOfItems']; ?>)";><</button>
           <input id="noOfItems" name="noOfItems" value="<?php echo $cart_item['noOfItems']; ?>" size="1" maxlength="2">
            <button id="add" onclick="add(<?php echo $cart_item['noOfItems']; ?>)";>></button></td>
