...
<body>
    ...
    <nav>
        <ul>
            <li>
                <a href="?page=orders">Ordrar</a>
            </li>
            <li>
                <a href="?page=products">Produkter</a>
            </li>
            <li>
                <a href="?page=productlines">Kategorier</a>
            </li>
            <li>
                <a href="?page=customers">Kunder</a>
            </li>
            <li>
                <a href="?page=administrators">Administratörer</a>
            </li>
            <li>
                <a href="?page=profile">Min Profil</a>
            </li>
        </ul>
    </nav>
        ...
        <div class="<?php if($page!="orders"){ echo "hidden";} ?>">
            ...
            <div>
                <div>
                    ...
                    <button name="previousPageOrders" type="submit">Förra sidan</button><?php } ?>
                </div>
                <div>
                    <button name="nextPageOrders" type="submit">Nästa sida</button>
                </div>
            </div>
            </form>
        </div>
        ...
        <div class="<?php if($page!="products"){ echo "hidden";} ?>">
            ...
            <div>
                <div>
                    ...
                    <button name="previousPageProducts" type="submit">Förra sidan</button><?php } ?>
                </div>
                <div>
                    <button name="nextPageProducts" type="submit">Nästa sida</button>
                </div>
            </div>
            </form>
        </div>
        ...
        <div class="<?php if($page!="productlines"){ echo "hidden";} ?>">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Kategori</th>
                        <th>Text Beskrivning</th>
                        <th>html Beskrivning</th>
                        <th>Bild</th>
                        <th>Redigera</th>
                    </tr>
                </thead>
            ...
            <div>
                <div>
                    ...
                    <button name="previousPageProductlines" type="submit">Förra sidan</button><?php } ?>
                </div>
                <div>
                    <button name="nextPageProductlines" type="submit">Nästa sida</button>
                </div>
            </div>
            </form>
        </div>
        ...
        <div class="<?php if($page!="customers"){ echo "hidden";} ?>">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Kundnummer</th>
                        <th>Kundens namn</th>
                        <th>Kontaktpersonens efternamn</th>
                        <th>Kontaktpersonens förnamn</th>
                        <th>Telefonnummer</th>
                        <th>addressrad 1</th>
                        <th>addressrad 2</th>
                        <th>Postort</th>
                        ...
                        <th>Postkod</th>
                        <th>Land</th>
                        <th>Säljarens arbetstagarnummer</th>
                        <th>Max Kredit</th>
                        <th>Redigera</th>
                        <th>Ta bort</th>
                    </tr>
            ...
            <div>
                <div>
                    ...
                    <button name="previousPageCustomers" type="submit">Förra sidan</button><?php } ?>
                </div>
                <div>
                    <button name="nextPageCustomers" type="submit">Nästa sida</button>
                </div>
            </div>
            </form>
        </div>
        ...
        <div class="<?php if($page!="administrators"){ echo "hidden";} ?>">
            ...
            <div>
                <div>
                    ...
                    <button name="previousPageAdmins" type="submit">Förra sidan</button><?php } ?>
                </div>
                <div>
                    <button name="nextPageAdmins" type="submit">Nästa sida</button>
                </div>
            </div>
            </form>
        </div>
